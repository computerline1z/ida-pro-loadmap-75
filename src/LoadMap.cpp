...
/// @date 2004.09.11 - 2018.11.08 - 2021.02.02
/// @version 1.4 - 2021.02.02 - Compiling in VS2019, SDK from IDA 7.5SP3
...
//--------------------------------------------------------------------------
struct loadmap_plugin_ctx_t : public plugmod_t
{
    virtual bool idaapi run(size_t) override;

    ~loadmap_plugin_ctx_t()
    {
        term();
    }
};
...
//--------------------------------------------------------------------------
bool idaapi loadmap_plugin_ctx_t::run(size_t)
{
    start(0);
    return true;
}
...
static plugmod_t* idaapi init()
{
    ...
    qstrncpy(g_szIniPath, idadir("cfg"), sizeof(g_szIniPath));
    ...
    case f_EXE:
    case f_BIN:
        return new loadmap_plugin_ctx_t;
    }
    return nullptr;
